...
import { tshirtFabrics } from '@/lib/data'
...
const shopCategories = [
  { icon: '🏪', name: 'Local fabric shops', count: 3, color: 'var(--sig-primary-soft)' },
  { icon: '🌐', name: 'Online shops', count: 12, color: 'var(--sig-success-soft)' },
  { icon: '♻️', name: 'Secondhand stores', count: 5, color: 'var(--sig-warn-soft)' },
]
  ...
  return (
    <div className="min-h-screen bg-bg pb-28">
      ...
      <div className="px-5 pt-14 pb-6">
        ...
        <p className="text-body text-ink-2">Everything for your Classic T-Shirt.</p>
      </div>
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <span className="text-caption font-semibold text-ink">
                    {fabric.quantityMeters}m needed
                  </span>
      ...
      <div className="fixed bottom-0 left-0 right-0 px-5 pb-8 pt-4 bg-gradient-to-t from-bg via-bg to-transparent">
        <Link href={`/garment/${id}/guide`}>
          <PrimaryButton>I have my materials — start sewing</PrimaryButton>
        </Link>
      </div>
    </div>
  )
